...
angular.module('app').controller('UploadLamidoCtrl', ['$scope', '$http', '$state', '$window', '$stateParams', 'editableThemes', 'FileUploader', 'toaster', 'Api_Path', 'Config_Status', 'Order', 'Location',
 	function($scope, $http, $state, $window, $stateParams, editableThemes, FileUploader, toaster, Api_Path, Config_Status, Order, Location) {
    /*
        Config
    */
