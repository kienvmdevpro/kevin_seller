...
angular.module('app').controller('ReturnOrderCtrl', ['$scope', '$http', '$state', '$window', '$timeout', '$stateParams', 'toaster', 'bootbox', 'Exchange',
 	function($scope, $http, $state, $window, $timeout, $stateParams, toaster, bootbox, Exchange) {
