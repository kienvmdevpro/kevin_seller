...
angular.module('app').controller('ExchangeCtrl', ['$scope', '$http', '$state', '$window', 'bootbox', 'toaster', 'PhpJs', 'Order',
 	function($scope, $http, $state, $window, bootbox, toaster, PhpJs, Order) {
