...
//Management
angular.module('app').controller('ExchangeOrderCtrl', 
			['$scope', '$http','$filter', '$state', '$window', '$timeout', '$stateParams', 'PhpJs', 'toaster', 'bootbox', 'Exchange', 'Order',
 	function($scope,   $http,   $filter,   $state,   $window,   $timeout,   $stateParams,   PhpJs,   toaster,    bootbox,   Exchange,   Order) {
        var timeout_sender;
